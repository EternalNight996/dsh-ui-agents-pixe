...
function apply(ctx) {
  ...
  try {
    if (settings) {
      scope = settings.register('agents-pixe', z.object({ enabled: z.boolean().default(false), cardMode: z.string().default('full') }), { base: (ctx.config && typeof ctx.config === 'object') ? ctx.config : {} })
      registerFace()
